...
import { hashPassword, validatePassword } from '../services/passwordAuth';
...
router.post('/users', verifyAdminPassword, async (req: Request, res: Response) => {
  try {
...
router.post('/users/:id/reset-pattern', verifyAdminPassword, async (req: Request, res: Response) => {
  try {
